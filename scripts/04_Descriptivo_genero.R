...
#creamos el boxplot
boxplots_genero <- ggplot(df_long, aes(x = "", y = value)) +
...
boxplots_genero
ggsave("visualization/Boxplots_genero.jpg", plot = boxplots_genero, width = 10, height =6, dpi = 300)
...
# plot with ggplot
acceso_justicia <- ggplot(access_summary, aes(x=Access_to_justice, y=count)) + 
  geom_bar(stat = "identity", color='black', fill='steelblue') +
  labs(title="Acceso de las mujeres a la justicia", 
       x="Nivel de acceso", y="Número de países")
acceso_justicia

ggsave("visualization/Acceso justicia.jpg", plot = acceso_justicia, width = 10, height =6, dpi = 300)
...
# plot with ggplot
Leyes_matrimonioinfantil <- ggplot(access_summary, aes(x=Child_marriage_law, y=count)) + 
  geom_bar(stat = "identity", color='black', fill='steelblue') +
  labs(title="Leyes de matrimonio infantil", 
       x="Nivel de igualdad", y="Número de países")
Leyes_matrimonioinfantil

ggsave("visualization/Leyes matrimonio infantil.jpg", plot = Leyes_matrimonioinfantil, width = 10, height =6, dpi = 300)
...
porcentajematrimonioinfantil <- ggplot(df_genderviolence, aes(y = Girls_married)) +
  geom_boxplot(fill = "steelblue", width = 0.5) +  
  ylab("Porcentaje") +
  ggtitle("Porcentaje de niñas casadas")  
porcentajematrimonioinfantil
ggsave("visualization/Porcentaje matrimonio infantil.jpg", plot = porcentajematrimonioinfantil, width = 6, height =6, dpi = 300)
...
leyes_hereditarias <- ggplot(access_summary, aes(x=Inheritance_law, y=count)) + 
  geom_bar(stat = "identity", color='black', fill='steelblue') +
  labs(title="Leyes hereditarias", 
       x="Nivel de igualdad", y="Número de países")
leyes_hereditarias
ggsave("visualization/Leyes hereditarias.jpg", plot = leyes_hereditarias, width = 10, height =6, dpi = 300)
...
leyes_violencia <- ggplot(access_summary, aes(x=Violence_against_women_law, y=count)) + 
  geom_bar(stat = "identity", color='black', fill='steelblue') +
  labs(title="Protección legal ante la violencia contra las mujeres", 
       x="Nivel de protección", y="Número de países")
leyes_violencia
ggsave("visualization/Leyes violencia de género.jpg", plot = leyes_violencia, width = 10, height =6, dpi = 300)
...
normalizacionviolencia <- ggplot(df_genderviolence, aes(y = Violence_against_women_attitudes)) +
  geom_boxplot(fill = "steelblue", width = 0.5) +  
  ylab("Porcentaje") +
  ggtitle("Porcentaje de mujeres que normalizan la violencia")  
normalizacionviolencia
ggsave("visualization/Porcentaje normalización de la violencia de género.jpg", plot = normalizacionviolencia, width = 6, height =6, dpi = 300)
...
victimasviolencia <- ggplot(df_genderviolence, aes(y = percentage_violence)) +
  geom_boxplot(fill = "steelblue", width = 0.5) +  
  ylab("Porcentaje") +
  ggtitle("Porcentaje víctimas de violencia de género")  
victimasviolencia
ggsave("visualization/Porcentaje víctimas violencia de género.jpg", plot = victimasviolencia, width = 6, height =6, dpi = 300)
...
leyes_nacionalidad <- ggplot(access_summary, aes(x=Citizenship_rights, y=count)) + 
  geom_bar(stat = "identity", color='black', fill='steelblue') +
  labs(title="Leyes sobre Nacionalidad", 
       x="Nivel de igualdad", y="Número de países")
leyes_nacionalidad
ggsave("visualization/Leyes nacionalidad.jpg", plot = leyes_nacionalidad, width = 10, height =6, dpi = 300)
...
leyes_voto <- ggplot(access_summary, aes(x=Inequality_voting_rights, y=count)) + 
  geom_bar(stat = "identity", color='black', fill='steelblue') +
  labs(title="Leyes sobre el voto", 
       x="Nivel de igualdad", y="Número de países")
leyes_voto
ggsave("visualization/Leyes voto.jpg", plot = leyes_voto, width = 10, height =6, dpi = 300)
...
mujeresparlamento <- ggplot(df_genderviolence, aes(y = percentage_women_parliament)) +
  geom_boxplot(fill = "steelblue", width = 0.5) +  
  ylab("Porcentaje") +
  ggtitle("Porcentaje de mujeres en el parlamento")  
mujeresparlamento
ggsave("visualization/Porcentaje mujeres en el parlamento.jpg", plot = mujeresparlamento, width = 6, height =6, dpi = 300)
...
sentimientoinseguridad <- ggplot(df_genderviolence, aes(y = Insecurity_feeling)) +
  geom_boxplot(fill = "steelblue", width = 0.5) +  
  ylab("Porcentaje") +
  ggtitle("Sentimiento de inseguridad de mujeres en la calle de noche")  
sentimientoinseguridad
ggsave("visualization/Porcentaje sentimiento inseguridad.jpg", plot = sentimientoinseguridad, width = 6, height =6, dpi = 300)
